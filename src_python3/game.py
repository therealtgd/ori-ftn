...
class Actions:
    ...
    _directions = {Directions.NORTH: (0, 1),
                   ...
                   Directions.EAST: (1, 0),
                   Directions.WEST: (-1, 0),
                   Directions.TWO_NORTH: (0, 2),
                   Directions.TWO_SOUTH: (0, -2),
                   Directions.TWO_WEST: (-2, 0),
                   Directions.TWO_EAST: (2, 0),
                   Directions.STOP: (0, 0)}
    ...
    def reverseDirection(action):
        ...
        if action == Directions.TWO_NORTH:
            return Directions.TWO_SOUTH
        if action == Directions.TWO_SOUTH:
            return Directions.TWO_NORTH
        if action == Directions.TWO_WEST:
            return Directions.TWO_EAST
        if action == Directions.TWO_EAST:
            return Directions.TWO_WEST
        return action
    ...
    def getPossibleActions(config, walls):
        ...
        for dir, vec in Actions._directionsAsList:
            ...
            next_y = y_int + dy
            next_x = x_int + dx
            if dir == Directions.TWO_NORTH:
                if walls[next_x][next_y - 1]: continue
            if dir == Directions.TWO_SOUTH:
                if walls[next_x][next_y + 1]: continue
            if dir == Directions.TWO_EAST:
                if walls[next_x - 1][next_y]: continue
            if dir == Directions.TWO_WEST:
                if walls[next_x + 1][next_y]: continue
            if next_x < 0 or next_x >= walls.width: continue  # sprecavamo izlazak sa table
            if next_y < 0 or next_y >= walls.height: continue  # sprecavamo izlazak sa table
